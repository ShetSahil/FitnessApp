...
<link rel="stylesheet2" href="stylesheets/loginstylesheet.css">
  ...
  <body> 
  <!-- add a logo --> 
  <div class = "logo"><a href = "homePage.php"><img src = "images/img27.jpg" style="width:10%"></a>
  </div>
...
<div class="bg"></div>
  ...
  <!-- greeting -->
  <center>
  <h2 style="text-shadow:1px 1px 0 #444">Here to make you fit</h2>
  </center>
...
<!-- <footer class="w3-padding-64 w3-light-grey w3-small w3-center" id="footer">
  ...
  <div class="w3-black w3-center w3-padding-24">Made by Apsit</div>
